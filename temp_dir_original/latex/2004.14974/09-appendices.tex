...
\input{tables/results-test-bootstrap.tex}
\input{tables/results-dev-bootstrap.tex}
...
\input{figures/multiple-rationales.tex}
...
\input{tables/journal-counts.tex}
...
We show a screenshot of the claim interface in Figure \ref{fig:claim_interface}. The annotation guide for claim verification follows.

\input{figures/claim-interface.tex}
